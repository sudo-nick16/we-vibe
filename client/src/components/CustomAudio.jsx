...
const CustomAudio = ({audio}) => {
    ...
    useEffect(() => {
        console.log(userState.currSong)
    },[userState.currSong])
        ...
        <div className="mt-auto">
            ...
            <div id="controls" className=" w-full h-14 flex flex-row items-center px-2 mt-1 justify-around bg-cdark-2">
            {
                ...
                <svg onClick={() => {
                    ...
                    } xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-clight-0" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div id="playback" className="h-6 w-48 overflow-x-hidden">
                ...
                {/* <div id="playback-circle" className="h-2 w-2 bg-blue-500 ml-50"></div> */}
            </div>
